...
from torchmetrics.functional.regression.spearman import _spearman_corrcoef_update
...
class GNNSiamese(torch.nn.Module):
    ...
    def forward(self, x1, edge_index1, batch1,x2, edge_index2, batch2):
        ...
        Args:
            x1 (Tensor): Input data: node features for all nodes in all graßphs of set 1
